...
export const SparklesIcon: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  ...
  >
    ...
    <path d="M19 19c.552 0 1-.448 1-1s-.448-1-1-1-1 .448-1 1 .448 1 1 1" />
    <path d="M5 5c.552 0 1-.448 1-1s-.448-1-1-1-1 .448-1 1 .448 1 1 1" />
  </svg>
);
...
export const LightbulbIcon: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  ...
  >
    ...
    <path d="M12 17v4" />
    <path d="M10 17h4" />
    <path d="M12 3a6 6 0 0 1 6 6c0 2-1 3.5-3 4l-2 2h-2l-2-2c-2-.5-3-2-3-4a6 6 0 0 1 6-6z" />
  </svg>
);
...
// Copy Icon (already exists in the current component, but adding for consistency)
